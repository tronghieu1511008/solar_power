...
// Bar Chart
var barChartReport_1 = document.getElementById('barChartReport_1').getContext('2d');
...
$(function () {
  $('#datepicker_1').datepicker({
    ...
    onClose: function (dateText, inst) {
      ...
      // 
      $.get('/datepicker_1?month=' + month + '&year=' + year, function (response) {
        ...
        var ChartReport_1 = new Chart(barChartReport_1, {
        ...
        $("#btnExcelPowerGenerate_1").click(function () {

          saveAs(new Blob([s2ab(wbout)], { type: "application/octet-stream" }), 'PowerGenerate_AS1_' + monthyear + '.xlsx');
        });
        // 
