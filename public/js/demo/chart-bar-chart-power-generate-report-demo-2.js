...
// Bar Chart
var barChartReport_2 = document.getElementById('barChartReport_2').getContext('2d');
...
$(function () {
  $('#datepicker_2').datepicker({
    ...
    onClose: function (dateText, inst) {
      ...
      // 
      $.get('/datepicker_2?month=' + month + '&year=' + year, function (response) {
        ...
        var ChartReport_2 = new Chart(barChartReport_2, {
        ...
        wb.Props = {
          Title: "Sheet Power Generate",
          Subject: "Power Generate" + monthyear,
          Author: "Huynh Trong Hieu",
          // CreatedDate: new Date(2017,12,19)
        };
        wb.SheetNames.push("Power Generate");
        var ws_data = data_excel;  //data excel
        var ws = XLSX.utils.aoa_to_sheet(ws_data);
        wb.Sheets["Power Generate"] = ws;
        ...
        $("#btnExcelPowerGenerate_2").click(function () {

          saveAs(new Blob([s2ab(wbout)], { type: "application/octet-stream" }), 'PowerGenerate_BS0_' + monthyear + '.xlsx');
        });
        //
      });
    }
