...
// Bar Chart
var barChartReport_3 = document.getElementById('barChartReport_3').getContext('2d');
    ...
    Chart.defaults.global.defaultFontSize = 16;
      ...
      $('#datepicker_3').datepicker( {
          ...
          onClose: function(dateText, inst) { 
              ...
              // 
              $.get('/datepicker_3?month='+month+'&year='+year , function( response ) {
                ...
                monthyear = thismonth + '/' + thisyear
                  var ChartReport_3 = new Chart(barChartReport_3, {
                  ...
                  $("#btnExcelPowerGenerate_3").click(function () {
          
                    saveAs(new Blob([s2ab(wbout)], { type: "application/octet-stream" }), 'PowerGenerate_BS1_' + monthyear + '.xlsx');
                  });
                  //
                  // 
                });
