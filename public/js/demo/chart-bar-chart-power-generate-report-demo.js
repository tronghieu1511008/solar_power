...
// Bar Chart
var barChartReport = document.getElementById('barChartReport').getContext('2d');
    ...
    onClose: function (dateText, inst) {
      ...
      $.get('/datepicker?month=' + month + '&year=' + year, function (response) {
        ...
        response.forEach(element => {
          cur_data[parseInt(element.day) - 1] = parseFloat(element.power);
        ...
        var massPopChart = new Chart(barChartReport, {
        ...
        $("#btnExcelPowerGenerate").click(function () {

          saveAs(new Blob([s2ab(wbout)], { type: "application/octet-stream" }), 'PowerGenerate_AS0_'+ monthyear +'.xlsx');
        });
        // 
      });
    }
