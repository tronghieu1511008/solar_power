...
// Bar Chart
var barChartPowerRemainReport_1 = document.getElementById('barChartPowerRemainReport_1').getContext('2d');
    // Global Options
    ...
    // Chart.defaults.global.defaultFontColor = '#777';
		...
		$(function() {
      $('#datepicker_powerRemain_1').datepicker( {
          changeMonth: true,
          changeYear: true,
          ...
          onClose: function(dateText, inst) { 
              ...
              // 
              $.get('/datepicker_powerRemain_1?month='+month+'&year='+year , function( response ) {
                ...
                monthyear = thismonth + '/' + thisyear
                  var PowerRemainChart_1 = new Chart(barChartPowerRemainReport_1, {
                  ...
                  $("#btnExcelPowerRemain_1").click(function () {
          
                    saveAs(new Blob([s2ab(wbout)], { type: "application/octet-stream" }), 'PowerRemain_AS1_' + monthyear + '.xlsx');
                  });
                  // 
                });
          }
