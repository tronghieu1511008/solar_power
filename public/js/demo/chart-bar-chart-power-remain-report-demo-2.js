...
// Bar Chart
var barChartPowerRemainReport_2 = document.getElementById('barChartPowerRemainReport_2').getContext('2d');
    // Global Options
    ...
    // Chart.defaults.global.defaultFontColor = '#777';
		...
		$(function() {
      $('#datepicker_powerRemain_2').datepicker( {
          changeMonth: true,
          changeYear: true,
          ...
          onClose: function(dateText, inst) { 
              ...
              // 
              $.get('/datepicker_powerRemain_2?month='+month+'&year='+year , function( response ) {
                ...
                monthyear = thismonth + '/' + thisyear
                  var PowerRemainChart_2 = new Chart(barChartPowerRemainReport_2, {
                  ...
                  $("#btnExcelPowerRemain_2").click(function () {
          
                    saveAs(new Blob([s2ab(wbout)], { type: "application/octet-stream" }), 'PowerRemain_BS0_' + monthyear + '.xlsx');
                  });
                  // 
                });
          }
