...
// Bar Chart
var barChartPowerRemainReport_3 = document.getElementById('barChartPowerRemainReport_3').getContext('2d');
    // Global Options
    ...
    // Chart.defaults.global.defaultFontColor = '#777';
		...
		$(function() {
      $('#datepicker_powerRemain_3').datepicker( {
          changeMonth: true,
          changeYear: true,
          ...
          onClose: function(dateText, inst) { 
              ...
              // 
              $.get('/datepicker_powerRemain_3?month='+month+'&year='+year , function( response ) {
                ...
                monthyear = thismonth + '/' + thisyear
                  var PowerRemainChart_3 = new Chart(barChartPowerRemainReport_3, {
                  ...
                  wb.Props = {
                    Title: "Sheet Power Remain",
                    Subject: "Power Remain" + monthyear,
                    Author: "Huynh Trong Hieu",
                    // CreatedDate: new Date(2017,12,19)
                  };
                  wb.SheetNames.push("Power Remain");
                  var ws_data = data_excel;  //data excel
                  var ws = XLSX.utils.aoa_to_sheet(ws_data);
                  wb.Sheets["Power Remain"] = ws;
                  ...
                  $("#btnExcelPowerRemain_3").click(function () {
          
                    saveAs(new Blob([s2ab(wbout)], { type: "application/octet-stream" }), 'PowerRemain_BS1_' + monthyear + '.xlsx');
                  });
                  // 
                });
          }
