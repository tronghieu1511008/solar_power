...
// Bar Chart
var barChartPowerRemainReport = document.getElementById('barChartPowerRemainReport').getContext('2d');
    // Global Options
    ...
    // Chart.defaults.global.defaultFontColor = '#777';
		...
		$(function() {
      $('#datepicker_powerRemain').datepicker( {
          changeMonth: true,
          changeYear: true,
          ...
          onClose: function(dateText, inst) { 
              ...
              // 
              $.get('/datepicker_powerRemain?month='+month+'&year='+year , function( response ) {
                ...
                monthyear = thismonth + '/' + thisyear
                  var PowerRemainChart = new Chart(barChartPowerRemainReport, {
                  ...
                  $("#btnExcelPowerRemain").click(function () {
          
                    saveAs(new Blob([s2ab(wbout)], { type: "application/octet-stream" }), 'PowerRemain_AS0_' + monthyear + '.xlsx');
                  });
                  // 
                });
          }
