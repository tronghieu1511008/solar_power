...
// Bar Chart
var barChartPowerUsageReport_1 = document.getElementById('barChartPowerUsageReport_1').getContext('2d');
    // Global Options
    ...
    // Chart.defaults.global.defaultFontColor = '#777';
		...
		$(function() {
      $('#datepicker_powerUsage_1').datepicker( {
          changeMonth: true,
          changeYear: true,
          ...
          onClose: function(dateText, inst) { 
              ...
              // 
              $.get('/datepicker_powerUsage_1?month='+month+'&year='+year , function( response ) {
                ...
                monthyear = thismonth + '/' + thisyear
                  var PowerUsageChart_1 = new Chart(barChartPowerUsageReport_1, {
                  ...
                  $("#btnExcelPowerUsage_1").click(function () {
          
                    saveAs(new Blob([s2ab(wbout)], { type: "application/octet-stream" }), 'PowerUsage_AS1_' + monthyear + '.xlsx');
                  });
                  // 
                });
          }
