...
// Bar Chart
var barChartPowerUsageReport_3 = document.getElementById('barChartPowerUsageReport_3').getContext('2d');
    // Global Options
    ...
    // Chart.defaults.global.defaultFontColor = '#777';
		...
		$(function() {
      $('#datepicker_powerUsage_3').datepicker( {
          changeMonth: true,
          changeYear: true,
          ...
          onClose: function(dateText, inst) { 
              ...
              // 
              $.get('/datepicker_powerUsage_3?month='+month+'&year='+year , function( response ) {
                ...
                monthyear = thismonth + '/' + thisyear
                  var PowerUsageChart_3 = new Chart(barChartPowerUsageReport_3, {
                  ...
                  $("#btnExcelPowerUsage_3").click(function () {
          
                    saveAs(new Blob([s2ab(wbout)], { type: "application/octet-stream" }), 'PowerUsage_BS1_' + monthyear + '.xlsx');
                  });
                  // 
                });
          }
