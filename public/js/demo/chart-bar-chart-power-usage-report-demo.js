...
// Bar Chart
var barChartPowerUsageReport = document.getElementById('barChartPowerUsageReport').getContext('2d');
    // Global Options
    ...
    // Chart.defaults.global.defaultFontColor = '#777';
		...
		$(function() {
      $('#datepicker_powerUsage').datepicker( {
          changeMonth: true,
          changeYear: true,
          ...
          onClose: function(dateText, inst) { 
              ...
              // 
              $.get('/datepicker_powerUsage?month='+month+'&year='+year , function( response ) {
                ...
                monthyear = thismonth + '/' + thisyear
                  var PowerUsageChart = new Chart(barChartPowerUsageReport, {
                  ...
                  $("#btnExcelPowerUsage").click(function () {
          
                    saveAs(new Blob([s2ab(wbout)], { type: "application/octet-stream" }), 'PowerUsage_AS0_' + monthyear + '.xlsx');
                  });
                  // 
                });
          }
